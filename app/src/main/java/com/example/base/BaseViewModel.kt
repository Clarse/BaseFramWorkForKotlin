...
import com.example.api.BaseResModel
import com.example.api.HttpUtil
import com.example.api.error.ErrorResult
import com.example.api.error.ErrorUtil
...
open class BaseViewModel : ViewModel() {
    ...
    private fun getSign(params: LinkedHashMap<String, String?>): String {
        ...
        val s = sb.toString().substring(0, sb.toString().length - 1).lowercase() + AUTH_SECRET
        return encryption(s)
    }
